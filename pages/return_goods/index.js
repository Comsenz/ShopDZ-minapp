...
Page({
    ...
    wx.request({
      ...
      success:function(res){
        ...
        if(res.data.code == 0){
          ...
          var order_state_text = res.data.data.order_state_text;
          console.log(orderlist);
          self.setData({
            list: orderlist,
            data:data,
            order_state_text: order_state_text,
            order_sn:order_sn,
          });
        }
      }
  ...
  onLoad: function (options) {
    ...
    // var order_sn = '201904111943355400';
  ...
  block:function(e){
    var refund_sn = e.currentTarget.dataset.id;
    var url = '../refund_detail/index?refund_sn=' + refund_sn+'&type=2';
    wx.navigateTo({
      url: url,
    });
    // var self = this;
  ...
  evaluation:function(e){
    ...
    if (self.data.data.goods_amount == self.data.data.order_amount){
      var url = '../questiong/question?order_sn=' + order_sn + '&rec_id=' + rec_id;
      wx.navigateTo({
        url: url,
      });
    }else{
